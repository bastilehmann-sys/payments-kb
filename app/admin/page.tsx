    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-border bg-card p-6 space-y-5">
        <div className="space-y-1">
          ...
          <p className="text-base text-muted-foreground">
            Wöchentlich vom Update-Agent generierte Vorschläge. Kommentieren, freigeben oder
            ablehnen.
          </p>
        </div>
        <Link
          href="/admin/proposals"
          className="inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2 text-base font-medium text-foreground transition-colors hover:bg-accent"
        >
          <svg
            className="size-4"
            viewBox="0 0 24 24"
