      ...
      {articleMd ? (
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-5 flex items-center gap-1.5 border-t border-border pt-3 text-xs text-muted-foreground">
            ...
            <span>Quelle:</span>
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono">content/gpdb_06_technik.md</code>
            <span className="text-muted-foreground/50">›</span>
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono">## {entry.id}</code>
          </div>
        </div>
      ) : (
