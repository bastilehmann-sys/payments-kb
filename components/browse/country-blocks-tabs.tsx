    ...
    <div className="group border-b border-border/60 last:border-0 py-4">
      <div className="flex items-start gap-4">
        ...
        <div className="w-44 shrink-0 pt-0.5">
          <span className="text-base font-semibold text-foreground">{row.feld}</span>
        </div>
            ...
            <div className="mt-4 space-y-3 border-l-2 border-amber-400/60 pl-4">
              {row.experte && row.experte.trim() && (
                <div>
                  ...
                  <p className="text-base text-foreground/75 leading-relaxed">{row.experte}</p>
                </div>
              )}
              {row.praxis && row.praxis.trim() && (
                <div>
                  ...
                  <p className="text-base text-foreground/75 leading-relaxed font-mono text-xs">
                    {row.praxis}
                  </p>
                </div>
              )}
