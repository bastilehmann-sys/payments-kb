...
const SERBIA = {
  ...
  currency: 'RSD',
  central_bank: 'National Bank of Serbia (NBS)',
  iso20022_status: 'Ja — NBS RTGS / Clearing / IPS / FX Clearing vollständig auf ISO 20022 seit November 2025. SWIFT MT/MX-Koexistenz für Cross-Border.',
  instant_payments: 'Ja — IPS NBS (24/7/365, ~1,2 sec, seit Oktober 2018)',
  intercompany_netting: 'Nein — Serbien kann nicht als Teilnehmer in einem Standard-IHB-Setup agieren; lokales Ausführungsmodell mit dokumentierten, KZ-gemeldeten IC-Krediten.',
  cash_pooling_external: 'Nein — tägliche automatische Sweeps aus RS-Konten nicht umsetzbar (FX-Kontrolle, Notional-Pooling-Cross-Guarantees verboten). Wöchentliche/monatliche manuelle Transfers.',
  pobo: 'Nein — nicht empfohlen wegen FX-Kontrolle und 60-Tage-Repatriierungsfrist für Exporterlöse.',
  pino_routing: 'Ja — PINO Forwarding/Routing möglich: RS-Entität initiiert über APM, Ausführung läuft über das lokale RS-Bankkonto (Header informiert, führt nicht aus).',
  special_format_requirements: 'NBS-Zahlungscodes („sifra placanja") Pflicht in <Purp><Prtry> auf jeder Zahlung (3-stellig, ~50 Codes). Resident haftet für falsche Codes. Für Tax-Zahlungen zusätzlich „poziv na broj" (Model 97) in <RmtInf>.',
  special_regulatory_requirements: 'NBS Mittelkurs für Buchhaltung/Steuer/Zoll zwingend (täglicher Feed nötig). Quartals-DI-1, KZ-1/2 binnen 10 Tagen, KZ-3B pro Transaktion. Exporterlöse 60 Tage Repatriierung. NBS prüft jede Cross-Currency-IC-Transaktion individuell.',
  key_note: '',
};
